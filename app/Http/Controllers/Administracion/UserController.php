...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
	   ...
	   $request->validate([
		...
		//se crea una notificación y se envía por mail
		$msg = Carbon::now().' - Está recibiendo esta notificación porque su usuario en el sistema <a href="'.url(config('app.url')).'">JUCO</a> fue modificado. <br>Nombre de usuario: '.$user->name.$pass;
