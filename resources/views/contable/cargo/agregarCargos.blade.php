...
<div class="row">
	...
	<div class="col-xs-12 visible-xs"><a href="{{ route('cargo.index') }}" class="btn btn-warning" style="margin-bottom:5%;" role="button"><i class="fas fa-list-ul"></i> Listado cargos</a></div>				  
</div>
<div class="row">
		...
		<div class="panel panel-warning">
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-sm-3 hidden-xs"><a href="{{ route('cargo.index') }}" class="btn btn-warning" role="button"><i class="fas fa-list-ul"></i> Listado cargos</a></div>
				</div>
			</div>
