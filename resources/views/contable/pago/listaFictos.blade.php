	...
	<div class="col-xs-12">
		...
		<div class="panel panel-warning text-warning">
			<div class="panel-heading">
				<a class="btn btn-success pull-right" href="{{ route('pago.create', ['idTipo' => 4]) }}" role="button"><i class="fas fa-plus"></i></a>
				<h4><i class="fas fa-dollar-sign"></i> LISTADO DE FICTOS ACTIVOS </h4>				
			</div>
			<div class="panel-body">
				<div class="table-responsive">
						<table id="tableExtras" class="table" style="width:100%" >
							...
							<tbody>
								@foreach($fictos->sortBy('empleado.empresa.razonSocial') as $pago)
								<tr>								
